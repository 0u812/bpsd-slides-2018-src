...
<span class="fragment fade-in-then-out" data-fragment-index="2" style="font-size:0.75em">Noble, Denis (1960). ["Cardiac action and pacemaker potentials based on the Hodgkin-Huxley equations"](https://doi.org/10.1038%2F188495b0). *Nature*. **188** (4749): 495–7.</span>
